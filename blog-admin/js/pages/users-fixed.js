...
function renderUsersPage() {
  ...
  tbody.innerHTML = items.map((user) => {
    ...
    const avatar = user.avatarUrl
      ? `<img src="${user.avatarUrl}" class="rounded-circle me-2" width="36" height="36" alt="${escapeHtml(displayName)}" />`
...
function editUser(id) {
  ...
  document.getElementById('previewAvatar').src = user.avatarUrl || '../assets/images/user2-160x160.jpg';
